...
?>
        ...
        <input style="border-radius: 25px;" type='submit' name='edit' value='Edit Details' onclick="window.location='edit_user.php'">
        <input  style="border-radius: 25px;" type='submit' name='logout' value='Logout' onclick="window.location='logout.php'">
        </div>
        </div>
    </div>
</section>
...
<footer> UGANDA POLICE &copy; 2020 </footer>
</html> 
